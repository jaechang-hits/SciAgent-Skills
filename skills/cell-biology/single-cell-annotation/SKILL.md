...
description: "Best practices for annotating cell types in single-cell RNA-seq data using marker-based, automated (CellTypist, scAnnotate), and reference-based (scArches, Azimuth, SingleR) approaches. Includes key marker genes, validation checklist, and tool selection guide."
license: CC-BY-4.0
compatibility: Python 3.10+, R 4.0+
metadata:
  authors: "Distilled from Luecken, M.D. et al."
  version: "1.0"
---
